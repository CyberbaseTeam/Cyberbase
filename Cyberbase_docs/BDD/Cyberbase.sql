...
CREATE SEQUENCE user_id MINVALUE 7 MAXVALUE 999999 INCREMENT 3 CYCLE;
alter table professionnel alter column tech_id set default 'P' || trim(to_char(nextval('professional_id'::regclass),'0000000')) ;
alter table usager alter column tech_id set default 'U'||trim(to_char(nextval('user_id'::regclass),'0000000'));
